...
CUSTOM_HAL_IMGSENSOR = imx298_mipi_raw s5k3p9_mipi_raw s5k3p9sx_mipi_raw gc0310_mipi_yuv
...
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p9_mipi_raw s5k3p9sx_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx298_mipi_raw s5k3p9_mipi_raw s5k3p9sx_mipi_raw gc0310_mipi_yuv
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p9_mipi_raw s5k3p9sx_mipi_raw
...
CUSTOM_MODEM=m860_TK_MD_BASIC-LWTG_R3_6765-fdd4m_gsm4_w12458_tdd40_fdd12345781217181920252666_tiaoxie_v10_0604_airoha_cotsx
...
#版本号
CUSTOM_BUILD_VERNO = R27_20190823
MTK_BUILD_VERNO = BV9100_EEA_M860A_V1.0_20190823V11

#分支名称
HCT_BUILD_PRODUCT_NAME = m860A-dk-dk010-cobom-63-512g48g-fhdplus-bom3-p0-cts
...
#品牌、型号、制造商
HCT_PRODUCT_NAME = BV9100_EEA
HCT_PRODUCT_MODEL = BV9100
...
#开发者选项里面“内存”菜单，移放到设置列表界面，摆放在存储菜单下面
HCT_MEMORY_IN_SETTING_HOMEPAGE = yes

#桌易桌面
HCT_FREEMELITE_SUPPORT = no
#单手模式
...
#fingerprint
HCT_VERSION_INCREMENTAL = 1563181284
